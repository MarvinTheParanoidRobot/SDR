...
public class GlgRealTimeChart extends GlgJBean implements ActionListener
{
   ...
   int StoredScrollState = 0;  /* Stored AutoScroll state to be restored if 
                                  ZoomTo is aborted. */
   ...
   // quantities of data.
   //////////////////////////////////////////////////////////////////////////  
   void PushPlotPointDirect( int plot_index, DataPoint data_point )
   {
      ...
      */
      ...
      GlgDataSample datasample = GlgObject.CreateDataSample( false );
      ...
      GlgObject.AddDataSample( Plot[ plot_index ], datasample );   
   }
      ...
      if( format.equals( "Button" ) )         /* Handle button clicks */
      {
         ...
         else if( origin.equals( "ZoomTo" ) )
         {
            if( ENABLE_ZOOM_TO_ON_BUTTON3 )
              ...
              SetDResource( "$config/GlgZoomToButton", 1.0 );
   ...
   void ChangeYAxisLabelType( int new_type )
   {
      ...
      switch( YAxisLabelType )
      {
       case 0:
         ...
         label1 = "Var2"; 
         label2 = "Var3"; 
         text_direction = GlgObject.HORIZONTAL_TEXT;
