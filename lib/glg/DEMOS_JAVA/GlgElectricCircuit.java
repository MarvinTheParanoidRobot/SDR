   ...
   */
   ...
   void UpdateCircuit()
   {
      ...
      if( UpdateWithData )
      {
         ...
         {
            AnimatedResource resource = (AnimatedResource)
   ...
   //////////////////////////////////////////////////////////////////////////
   // Prints resources of the drawing used for animation (resources whose
   ...
   // by traversing all resources of the drawing and creating a list of
   // resources of interest that are marked by the "#" characted at the 
   // beginning of their names. 
   //
   // Alternatively, tags may be used instead of resources. Tags are 
   // reported as a flat list and are easier to process for a typical 
   ...
   GlgObject GetResourceList( GlgObject obj, String res_path, GlgObject list )
   {
      ...
      for( int i=0; i<size; ++i )
      {
         ...
         {
            AnimatedResource resource = new AnimatedResource();
