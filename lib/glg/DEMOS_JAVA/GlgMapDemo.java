...
public class GlgMapDemo extends GlgJBean implements ActionListener
{
   ...
   GlgObject
     Drawing = null,
     MapContainer = null, // Viewport used as a parent of a loaded map viewport.
     LinkTemplate = null,
     IconArray = null,
   ...
   void Initialize()
   {
      ...
      */
      ...
      Drawing.SetDResource( "SelectionDialog/DialogHeight", 150.0 );
      Drawing.SetDResource( "SelectionDialog/DialogY", -700.0 );
   ...
   void LoadMap()
   {
      ...
      MapViewport = 
         GlgObject.LoadWidget( GetFullPath( map_file ), StandAlone ? GlgObject.FILE : GlgObject.URL );
   ...
   void UnloadMap()
   {
      ...
      MapContainer.DeleteObject( MapViewport );
      MapViewport = null;
   }
   ...
   public void InputCallback( GlgObject vp, GlgObject message_obj )
   {
      ...
      if( format.equals( "Button" ) )
      {
         ...
         else if( origin.equals( "MapType" ) )  // Toggle US and world map
         {
