...
public class GlgTrajectoryDemo extends GlgJBean implements ActionListener
{
   ...
   int ZoomLevel = 2;
   boolean Pause = false;
   boolean NewTrajectoryMode = false;
   ...
   public void InputCallback( GlgObject viewport, GlgObject message_obj )
   {
      ...
      if( format.equals( "Button" ) )         // Handle button clicks
      {
         ...
         else if( origin.equals( "NewTrajectory" ) )
         {
      ...
      switch( event_type )
      {
       case MouseEvent.MOUSE_PRESSED:
         ...
         */ 
         ...
         NewTrajectoryPolygon = new GlgPolygon( 2, null );
   ...
   //////////////////////////////////////////////////////////////////////////
   void AbortNewTrajectoryMode()
   {
      // Remove prompt if it's visible.
      Map.SetDResource( "Prompt/Visibility", 0.0, true );

      if( NewTrajectoryPolygon != null )
      {
         if( GISObject.ContainsObject( NewTrajectoryPolygon ) )
           GISObject.DeleteObject( NewTrajectoryPolygon );
