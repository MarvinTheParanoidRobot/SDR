This example demonstrates how to use a GLG bean to display and animate
a GLG drawing, as well as handle user interaction.
...
"DialPressure", "StartButton", "QuitButton", etc.
...
The program also demonstrates handling user interaction in a GLG
widget, using Input callback. For example, clicking on a Quit button
exits the program, Start/Stop button toggles animation on/off, and a
slider controls the value if the pressure dial.
