...
raw_data.h provides an example of the custom data structures and should
be customized by the application as needed.
...
1. Provide custom implementation of the following modules and methods:
  ...
  Data structures, defined in raw_data.h
  LiveDataFeed::Init()
...
2. Set RANDOM_DATA flag to false (either in main.cpp or
GlgViewer.cpp), or use -live-data command line option.
