...
application data are generated by the LiveDataFeed class. 
The application developer should provide custom data acquisition code 
in LiveDataFeed class to communicate with the application specific 
...
1. Provide custom implementation of the Read/Write methods in LiveDataFeed.cpp.

2. Set RANDOM_DATA flag in GlgViewer.cpp to false, or use -live-data command 
   line option. 
