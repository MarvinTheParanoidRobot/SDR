...
//////////////////////////////////////////////////////////////////////////////
function RTChartPage( /* GlgObject */ viewport )
{
   ...
   */
   ...
   this.AutoScroll = 1;      /* int: Current auto-scroll state: enabled(1) or 
                                disabled(0). */
   this.StoredScrollState;   /* int: Stored AutoScroll state to be restored 
...
////////////////////////////////////////////////////////////////////////////// 
RTChartPage.prototype.GetUpdateInterval = function()   /* int */
{
   return 100;
}
...
////////////////////////////////////////////////////////////////////////////// 
RTChartPage.prototype.InitAfterSetup = function()
{
   var i;
   ...
   */
   ...
   for( var i=0; i<this.NumPlots; ++i )
   {
      ...
      var tag_source =    /* String  */
        this.PlotArray[ i ].GetSResource( "ValueEntryPoint/TagSource" );

      var data_array =    /* PlotDataPoint[] */
        DataFeed.GetPlotData( tag_source, start_time, end_time,
                              max_num_samples );
      if( data_array == null )
        continue;
...
////////////////////////////////////////////////////////////////////////////// 
RTChartPage.prototype.FillPlotData =
  function( /* GlgObject */ plot, /* PlotDataPoint[] */ data_array )
{
...
// events and commands.
//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.InputCallback =
  function( /* GlgObject */ viewport, /* GlgObject */ message_obj ) /* boolean */
{
   ...
   if( format == "Button" )   
   {
      ...
      */
      ...
      {
         // Scroll up by 1/2 of the vertical span.
         this.ChartVP.SetZoom( null, 'u', 0.5 );
      }
      else if( origin == "Down" )
      {
         // Scroll down by 1/2 of the vertical span.
...
//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.TraceCallback =      /* boolean */
...
//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.NeedTagRemapping = function ()   /* boolean */
{
...
//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.RemapTagObject =
...
//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.AdjustForMobileDevices = function()
{
   ...
   */
   var chart =     /* GlgObject */
     this.Viewport.GetResourceObject( "ChartViewport/Chart" );
...
//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.PerformZoom = function( /* String */ zoom_type )
{
   this.PerformChartZoom( zoom_type );
}

//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.PerformChartZoom = function( /* String */ zoom_type )
{
   switch( zoom_type )
   {
    case 'i':
    ...
    case 'r':
      ...
      // Scroll left or right by 1/3 of the span.
      this.ChartVP.SetZoom( null, zoom_type, 0.33 );
      break;

    case 'u':
    case 'd':
      // Scroll up or down by 1/2 of the vertical span.
      this.ChartVP.SetZoom( null, zoom_type, 0.5 );
      break;
...
RTChartPage.prototype.ChangeAutoScroll = function( /* int */ new_value )
{
   ...
   {
      this.AutoScroll = 
        Math.trunc( this.Viewport.GetDResource( "Toolbar/ToggleAutoScroll/OnState" ) );
   }
   else    // Set to the supplied value. 
   {
      this.AutoScroll = new_value;
      this.Viewport.SetDResource( "Toolbar/ToggleAutoScroll/OnState", 
                                  this.AutoScroll );
   }
...
RTChartPage.prototype.SetChartSpan = function( /* int */ span_index )
{
   ...
   switch( span_index )
   {
    ...
    case 1:
      ...
      major_interval = this.ONE_MINUTE * 2; /* major tick every tow minutes. */
    ...
    case 3:
      ...
      minor_interval = this.ONE_MINUTE * 15; /* minor tick every 15 minutes. */
      break;
   }
   
   /* Update the menu in the drawing with the initial value if different. */
   this.Viewport.SetDResourceIf( "Toolbar/SpanSelector/SelectedIndex", 
                                 span_index, true );
   ...
   */
   if( span_index > 1 )
   {
      ...
      */
      this.PlotArray[0].SetDResource( "FilterType", 
...
{
   var time_label_format, time_tooltip_format, chart_tooltip_format; /* String */
...
//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.ScrollToDataEnd =
  function( /* int */ data_end, /* boolean */ show_extra )
{
...
// chart.
//////////////////////////////////////////////////////////////////////////////
RTChartPage.prototype.GetExtraSeconds = function()   /* double */
{
