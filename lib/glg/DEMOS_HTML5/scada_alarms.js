...
var MessageDialog;        /* GlgObject : Popup dialog used for a help message. */
...
function ShowAlarms( title )
{
   ...
   */
   if( AlarmDialog == null )
     GLG.LoadWidgetFromURL( "scada_alarms.g", null, AlarmLoadCB, 
                            /* user data */ title );
   else
   {
...
function InitAlarmDialogBeforeH()
{
   ...
   SetupMessageDialog(); // Set up a message dialog used for help.
...
function GetAlarmData()
{
   if( DataFeed != null )
   {
      var alarm_list = DataFeed.GetAlarms();

      if( alarm_list != null )
      {
         /* Store the obtained alarm list, it will be used to scroll the 
            alarm list using scrollbars.
         */
...
function ShowAlarmDialog( /* boolean */ show )
{
   ...
   if( show && FirstAlarmDialog )   // Show the help message the first time only.
   {
...
//////////////////////////////////////////////////////////////////////////
function AlarmInputCallback( /* GlgObject */ viewport,
                             /* GlgObject */ message_obj )
{
   ...
   // Handle window closing - erase dialogs.
   ...
   else if( format == "CustomEvent" )      // Handle custom events.
   {
...
function SetupMessageDialog()
{
   ...
   */
   ...
   MessageDialog.SetSResource( "ScreenName", "Message Dialog" );
