   ...
   implements ActionListener, GlgHierarchyListener 
{
   ...
   */
   ...
   boolean FirstAlarmDialog = true; /* Used to show a help message when the
   ...
   */
   ...
   public void VCallback( GlgObject viewport )
   {
      ...
      SelectMainMenuItem( 0, /* update menu object */ true );
      ...
      for( int i=0; i<num_tag_records; ++i )
      {
         ...
         switch( tag_record.data_type )
         {
          case GlgObject.D:
            ...
            if( DataFeed.ReadDTag( tag_record, d_data_point ) )
            {
               /* Push a new data value into a given tag. The last argument 
                  ...
                  into the object.
               */
               SetDTag( tag_record.tag_source, d_data_point.d_value, false );
          ...
          case GlgObject.S:    
            ...
            {
               // Push new data.
               SetSTag( tag_record.tag_source, s_data_point.s_value, false );
            }
            break;
         }
      }
                                        ...
                                        GlgObject message_obj )
   {
      ...
      */
      ...
      if( format.equals( "Menu" ) )
      {
         ...
         */
         ...
         SelectMainMenuItem( menu_index, /* don't update menu object */ false );
      ...
      */
      ...
      {
         if( origin == null || 
             !action.equals( "Activate" ) &&      /* Not a push button */
   ...
   //////////////////////////////////////////////////////////////////////////
   // Used to handle low level events, such as obtaining coordinates of 
   ...
   //////////////////////////////////////////////////////////////////////
   boolean LoadDrawingFromMenu( int screen )
   {
      ...
      */
      else
      {
         ...
         */
         ...
         if( subwindow == null )
         {
            System.out.println( "PopupDialog Command failed: Destionation object not found." );
            ClosePopupDialog( dialog_type );
            return;
         }
   ...
   public void PositionPopupMenu()
   {
      ...
      */   
      ...
      if( converted_box.p1.y - menu_height < 0.0 ) 
      {
                     ...
                     GlgObject command_obj )
   {
      ...
      */
      ...
      else
      {
         ...
         if( subwindow == null )
         {
            System.out.println( "GoTo Command failed: Invalid Destionation." );
            return;
         }
      }
   ...
   //////////////////////////////////////////////////////////////////////////
   public void SelectMainMenuItem( int menu_index, boolean update_menu )
   {
      /* Validate menu_index. */
