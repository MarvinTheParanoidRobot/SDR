...
function InitAfterH()
{
    ...
    */
    for( i=0; i<NumPlots; ++i )
    {
        ...
        PlotArray.push( 
            new PlotInfo( plot, value_ep, time_ep, valid_ep, tag_source ) ); 
    }
